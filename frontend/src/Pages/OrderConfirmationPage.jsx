...
// import { clearCart } from "../../redux/slice/cartSlice"; // adjust this path
import { clearCart } from "../redux/slice/cartSlice"; // use correct relative path
...
useEffect(() => {
    ...
    const caluculateEstimateDelivery = (createdAt)=>{
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-white">
            <h2 className="text-4xl font-bold text-center text-emerlad-700 mb-8">
                ...
                <div className="flex justify-between mb-20">
                    ...
                    <div>
                        <p className="text-emerald-700 text-sm">
                            Estimated Delivery :{" "}
                            {caluculateEstimateDelivery(checkout.createdAt)}
                        </p>
                    </div>
                </div>
                {/* order itmes  */}
