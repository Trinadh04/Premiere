...
import { logout } from "../redux/slice/authslice"; // adjust the path if needed
import { clearCart } from "../redux/slice/cartSlice"; // ✅ Adjust path based on your folder structure
