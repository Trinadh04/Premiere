...
//                                 {new Date(OrderDetails.ceatedAt).toLocaleDateString()}
//                             </p>
//                         </div>
...
//                <span className={`${OrderDetails.isDelivered ? "bg-green-100 text-yellow-700":"bg-red-100 text-red-700"} px-3 py-1 rounded-full text-sm font-medium mb-2`}>
//                             {OrderDetails.isDelivered ? "Delivered":"Pending Delivery"} </span>
                            
//                         </div>
//                     </div>
//                     {/* coustmer,payment,shipping info  */}
//                     <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8">
//                         <div>
//                             <h4 className="text-lg font -semibold mb-2">PaymentInfo</h4>
//                             <p>PaymentMethod:{OrderDetails.PaymentMethod}</p>
//                             <p> Status:{OrderDetails.isPaid ? "Paid":"Unpaid"}</p>
//                         </div>
//                         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8">
//                         <div>
//                             <h4 className="text-lg font -semibold mb-2">ShippingInfo</h4>
//                             <p>ShippingMethod:{OrderDetails.shippingMethod}</p>
...
//                                             <Link  to={'/product/${items.productId}'} className="text-blue-500 hover:underline">
//                                             {items.name}
//                                             </Link>
//                                         </td>
