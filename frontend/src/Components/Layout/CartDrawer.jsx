...
const CartDrawer = ({drawerOpen,toggleCartDrawer})=>{
  ...
  const handleCheckout =  () =>{
    ...
    return(
        ...
        transform translation-transform duration-300 flex flex-col z-50  ${
      ...
      <div className="p-4 bg-white sticky  bottom-0">
        ...
        <p className="text-sm tracking-tighter text-gray-600 mt-2 text-center"> shipping,Taxes and discount codes caluculated at checkout</p>
          </>
        )}
