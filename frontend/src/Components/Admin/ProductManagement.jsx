...
//                     <td className="p-4">
//                         <Link to={`/admin/products/${products._id}/edit`} className="bg-yellow-500 text-white px-2 py-1 rounded mr-2 hover:bg-yellow-600">Edit</Link>
//                         <button onClick={() => handleDelete(product._id)}
//                          className="bg-red-500 text-white px-2 py-1 rounded hover:bg-red600">Delete</button>
//                     </td>
//                 </tr>
//                 ))
//             )
