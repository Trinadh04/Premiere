...
// //                     <input type="number" name="count in Stock" value={productData.countInstock}
// //                     onChange={handleChange}
// //                     className="w-full border border-gray-300 rounded-md p-2"
// //                     />
// //                 </div> */}
...
// //                 {/* Image upload */}
// //                 <div className="mb-6">
// //                     <label  className="block font-semibold mb-2">Upload Iamge</label>
...
// import { fetchProductDetails, updateProduct } from "../../redux/slice/productSlice"; // Adjust path if needed
...
const EditProductPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    navigate("/admin/products"); // ✅ Correct path
  };
