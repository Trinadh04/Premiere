            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                ...
                <div className="flex flex-col items-center">
                    <div className="p-4 rounded-full mb-4">
                        <HiShoppingBag className="text-xxl"/>
                    </div>
                    <h4 className="tracking-tighter mb-2">
                        FREE INDIA WIDE SHIPPING
                    </h4>
                    <p className="text-gray-600 text-sm tracking-tighter">On all oreders over  ₹ 2000 </p>
                </div>
                 {/* feature 1 */}
                <div className="flex flex-col items-center">
                    <div className="p-4 rounded-full mb-4">
                        <HiArrowPathRoundedSquare className="text-xxl"/>
                    </div>
                    <h4 className="tracking-tighter mb-2">
                        7 DAYS RETURN
                    </h4>
                ...
                <div className="flex flex-col items-center">
                    <div className="p-4 rounded-full mb-4">
                        <HiOutlineCreditCard className="text-xxl"/>
                    </div>
                    <h4 className="tracking-tighter mb-2">
                        SECURE CHECKOUT
                    </h4>
