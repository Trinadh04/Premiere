    ...
    return (
        <section className =" py-16 px-4 lg:px-0">
            <div className="container mx-auto flex flex-col-reverse lg:flex-row item-center bg-green-50 rounded-3xl">
                ...
                <p className="text-lg text-gary-600 mb-6"> Discover high-quality, comfortable clothing that effortlessly blend
                ...
                <img src={featured} alt="Featured Collection" className="w-full h-full object-cover lg:rounded-br-3xl:"/></div>
            </div>
        </section>
    )
}
