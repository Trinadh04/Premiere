...
export const fetchProductsByFilters = createAsyncThunk(
  ...
  async ({
    ...
    const addParam = (key, val) => {
      if (Array.isArray(val)) {
        ...
        if (filtered.length > 0) {
          query.set(key, filtered.join(",")); // ✅ Array to comma-separated
        }
      } else if (val !== undefined && val !== "" && val !== null) {
        query.set(key, val); // ✅ Avoid empty strings
      }
    };
    ...
    addParam("material", material);
    addParam("brand", brand);
    addParam("limit", limit);

    // ✅ Debug log
    console.log("🚀 Final Query Params:", query.toString());
